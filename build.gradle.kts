...
// build is not a release and says so. A checkout without the git command counts as having no .git.
version = providers.gradleProperty("releaseVersion")
	.orElse(gitDescribedVersion())
	.getOrElse("0.0.0-dev")

fun gitDescribedVersion(): Provider<String> = providers.provider {
